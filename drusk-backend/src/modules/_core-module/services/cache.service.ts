...
/**
 * cache component that can store and retriece data
 * 
...
export class CacheService {
     ...
     * @param callback callback is optional function fires after entry has expired with key and value passed (function(key, value) {})
     */
